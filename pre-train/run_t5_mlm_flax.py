...
Here is the full list of checkpoints on the hub that can be pretrained by this scripts:
...
# You can also adapt this scripts on your own masked language modeling task. Pointers for this are left as comments.
...
class TrainingArguments:
    ...
    project_name: str = field(
        default="pre-train",
        metadata={"help": "The name of the project to which the logged results will be uploaded."},
    )
    run_name: str = field(
        metadata={"help": "A descriptor for the run. Typically used for `run_name` in wandb."},
    )
    #####
...
def main():
    ...
    # or by passing the --help flag to this scripts.
    # We now keep distinct sets of args, for a cleaner separation of concerns.

    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, TrainingArguments))

    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):
        # If we pass only one argument to the scripts and it's the path to a json file,
    ...
    os.environ["CUDA_VISIBLE_DEVICES"] = training_args.total_gpu
    ###
    ...
    ###
    command = 'wandb login --relogin b3bfb2571805cf937a893d15b6621429ffb21e22'
    os.system(command)
    ...
    def decay_mask_fn(params):
        ...
        layer_norm_named_params = {
            ...
            if layer_norm_name in "".join(layer) # NEW: Remove .lower()
        }
        ...
        for step, batch_idx in enumerate(tqdm(train_batch_idx, desc="Training...", position=1)):
            ...
            if cur_step % training_args.logging_steps == 0 and cur_step > 0:
                ...
                wandb.log({
                    ...
                    "Train Learning Rate": train_metric['learning_rate'],
                }, step=epoch)
                #####
